...
export const VocabularyCategoryManagementScreen: React.FC<
  SettingsScreenProps<'VocabularyCategoryManagement'>
> = () => {
  ...
  const addCategory = vocabStore.addCategory;
  const updateCategory = vocabStore.updateCategory;
  const deleteCategory = vocabStore.deleteCategory;
