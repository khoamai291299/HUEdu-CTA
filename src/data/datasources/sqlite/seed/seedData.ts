...
export const SEED_VOCABULARY: SeedVocabulary[] = [
  ...
  {nameVi: 'Ăn cơm', nameEn: 'Eat rice', speechTextVi: 'Con muốn ăn cơm', speechTextEn: 'I want to eat rice', categoryKey: 'act_eat', type: 'activity', sortOrder: 1, imagePath: 'lucide:Utensils'},
  {nameVi: 'Uống nước', nameEn: 'Drink water', speechTextVi: 'Con muốn uống nước', speechTextEn: 'I want to drink water', categoryKey: 'act_eat', type: 'activity', sortOrder: 2, imagePath: 'lucide:Droplet'},
  {nameVi: 'Ăn bánh', nameEn: 'Eat cake', speechTextVi: 'Con muốn ăn bánh', speechTextEn: 'I want to eat cake', categoryKey: 'act_eat', type: 'activity', sortOrder: 3, imagePath: 'lucide:Utensils'},
  
  {nameVi: 'Con muốn chơi', nameEn: 'I want to play', speechTextVi: 'Con muốn chơi đồ chơi', speechTextEn: 'I want to play toys', categoryKey: 'act_play', type: 'activity', sortOrder: 1, imagePath: 'lucide:Gamepad2'},
  {nameVi: 'Đọc sách', nameEn: 'Read', speechTextVi: 'Con muốn đọc sách', speechTextEn: 'I want to read a book', categoryKey: 'act_play', type: 'activity', sortOrder: 2, imagePath: 'lucide:Book'},
  {nameVi: 'Nghe nhạc', nameEn: 'Listen to music', speechTextVi: 'Con muốn nghe nhạc', speechTextEn: 'I want to listen to music', categoryKey: 'act_play', type: 'activity', sortOrder: 3, imagePath: 'lucide:Music'},
];
